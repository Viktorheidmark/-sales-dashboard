...
export function Sidebar({ supplierName, onLogout, onNavigate }: SidebarProps) {
  ...
  return (
    <div className="flex h-full flex-col bg-slate-900 select-none">
      {/* Wordmark */}
      <div className="px-5 py-6 border-b border-white/5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-sm font-semibold text-white leading-tight tracking-tight">Solvigo</div>
            <div className="text-[9px] font-medium tracking-[0.22em] uppercase text-slate-500 leading-tight mt-0.5">
              Sales Intelligence
            </div>
          </div>
        </div>
      ...
      <nav className="flex-1 px-3 py-5 space-y-0.5">
        <p className="text-[9px] font-semibold text-slate-600 uppercase tracking-[0.2em] px-3 mb-3">
          Navigering
        </p>
        {NAV_ITEMS.map(item => (
          <NavLink
      ...
      <div className="px-4 py-5 border-t border-white/5">
        <div className="flex items-center gap-2.5 px-1 mb-4">
          <div className="w-8 h-8 rounded-full bg-slate-700 border border-white/10 flex items-center justify-center shrink-0 text-xs font-semibold text-white">
            {initial}
          </div>
        ...
        <button
          onClick={onLogout}
          className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-xs font-medium text-slate-500 hover:text-slate-200 hover:bg-white/5 transition-colors"
        >
